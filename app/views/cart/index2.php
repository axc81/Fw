...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div>                   
                    <a href="<?= BASE_URL; ?>/Keranjang/detailKeranjang/<?= $_SESSION['username']; ?>" class="btn btn-primary" />Lihat Keranjang</a>
                </div>
                <!-- /.div -->
            </div>
            <!-- /.col -->
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12 text-center col-sm-12 col-xs-12">
                        <h2><?= $data['pro']['name'];?></h2>
                        <img src="<?= BASE_URL; ?>/img/<?= $data['pro']['image']; ?>" width="300" height="460"/>
                        <hr>
                  		<p><?= $data['pro']['description'];	 ?></p>
                  		<!-- button -->
                  		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addItem">Tambah Ke Keranjang</button>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
          ...
          <div class="modal-body">
            ...
            <form action="<?= BASE_URL; ?>/Keranjang/postItem" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="hidden" name="pid" value="<?= $data['pro']['id']; ?>">
                    <label for="formGroupExampleInput"><h3><?= $data['pro']['name']; ?></h3></label> 
                    <img src="<?= BASE_URL; ?>/img/<?= $data['pro']['image'];?>" width="200" height="270" style="display: block; margin: auto;"/>
                    <label for="formGroupExampleInput2"><h2>Price :&nbsp;&nbsp;&nbsp;Rp.<?= $data['pro']['price']; ?></h2></label>
