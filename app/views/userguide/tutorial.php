<!DOCTYPE html>
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<h3>TUTORIAL</h3>
			<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for tutorial.." title="Type in a name">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
						<span id="myUL">
							<br>
							Terimakasih telah menggunakan <b>ANscript</b>.<br>
							Berikut adalah kumpulan tutorial dasar guna membantu pengembang untuk beradaptasi dengan framework ANscript.
							<hr>
							<li><a href="<?= BASE_URL; ?>/userguide/instalasi" id="sf">I N S T A L A S I</a></li>
							<li><a href="<?= BASE_URL; ?>/userguide/konfigurasi" id="sf">K O N F I G U R A S I</a></li>
							<li><a href="<?= BASE_URL; ?>/userguide/tutorial_controller" id="sf">C O N T R O L L E R</a></li>
							<li><a href="<?= BASE_URL; ?>/userguide/tutorial_model" id="sf">M O D E L</a></li>
							<li><a href="<?= BASE_URL; ?>/userguide/tutorial_view" id="sf">V I E W</a></li>
							<br><br>
							<br>
						</span>
					</div>
