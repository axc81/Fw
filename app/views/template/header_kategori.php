        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="<?= BASE_URL; ?>" data-animate-hover="bounce">
                    <img src="<?= BASE_URL; ?>/img/img/cl.png" alt="" class="hidden-xs">
                    <img src="<?= BASE_URL; ?>/img/img/logo-small.png" alt="" class="visible-xs"><span class="sr-only"></span>
                </a>
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li class="active"><a href="<?= BASE_URL; ?>/beranda">Home</a>
                    </li>
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    ...
                    <a href="<?= BASE_URL; ?>/beranda" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm"></span></a>
                </div>
                <!--/.nav-collapse -->
