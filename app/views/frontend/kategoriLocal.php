 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked kategori-menu">
                                <li>
                                    <a href="<?= BASE_URL; ?>/Kategori/katLoc/local">Local<span class="badge pull-right"><?= $data['show']; ?></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Coffeelab</h1>
                        <p>Temukan Biji Kopi Local Terbaik Hanya Di COFFEELAB.</p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <?php foreach ($data['local'] as $product) {?>
                            ...
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="buttons">
                                        ...
                                        <a href="<?= BASE_URL; ?>/Keranjang/detailKeranjang/<?= $_SESSION['username']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a> 
                                    </p>
                                </div>
                                <!-- /.text -->
                            </div>
